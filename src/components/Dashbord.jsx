    ...
    submit_regelment_vente = (e) => {
        ...
        switch (regelementvente) {
            case 'espece':
                ...
                break;
            case 'cheque':
                var check_btns_regelment = document.getElementById("check_btns_regelment_id1").value;
    ...
    submit_regelment_avoire = (e) => {
        ...
        switch (regelementavoire) {
            case 'espece':
                ...
                break;
            case 'cheque':
                var check_btns_regelment = document.getElementById("check_btns_regelment_id_avoire").value;
                if (check_btns_regelment === '') {
                    alert("You have to type the check number");
                } else {
                    obj.type_of_paying = 'cheque';
...

                                        {
                                            ...
                                            this.state.vente_add.map((val, index) => {
                                                ...
                                                return (
                                                    ...
                                                    <tr id={'vente_remove_element' + index} key={index}>
                            ...
                            <div className='fourn_info_add_product'>
                                ...
                                <div className='fourn_select_add_product'>
                                    ...
                                    <select onClickCapture={this.selectfourn} required name='fourn_select_add_product_name' id='fourn_select_add_product_id1' >
                                        ...
                                        {
                                            this.state.selectfourn.map((val,index) => {
                                ...
                                <div className='generale_add_client_select'>
                                    ...
                                    <select onClickCapture={this.selectgenerale} required name='generale_add_client_select_name' id='generale_add_client_select_id1' >
...

                                        {
                                            ...
                                            this.state.generale.map((val,index) => {
                    ...
                    
                    {
                        ...
                        this.state.notifi.map((val, index) => {
                            ...
                            return (
                                ...
                                <div key={index} className='info1_notif_heading'>
...

                                {
                                    this.state.listinfocredit.map((val, index) => {
                                        ...
                                        return (
                                            ...
                                            <li key={index}><span className="fa-li"><i className="fas fa-arrow-alt-circle-right"></i></span><p>{val.Date_operation_info_list_credit}</p><p>{val.montant_info_list_credit}</p></li>
...

                                {
                                    this.state.listinfoproduct.map((val, index) => {
                                        ...
                                        return (
                                            ...
                                            <li key={index}><p>{val.Date_operation_info_product}</p><p>{val.qty_info_product}</p><p>{val.prix_devis_info_product}</p><p>{val.prix_achat_info_product}</p><p>{val.prix_vente_info_product}</p></li>
